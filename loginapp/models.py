...
class Booking(models.Model):
    ...
    loginid=models.CharField(max_length=20,null=True,blank=True)
    bookingdate=models.CharField(max_length=20,null=True,blank=True)
    bookingtime=models.CharField(max_length=20,null=True,blank=True)
    products=models.CharField(max_length=20,null=True,blank=True)
    deliverystatus=models.CharField(max_length=20,null=True,blank=True)
